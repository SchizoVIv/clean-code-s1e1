...
alert("Я по привычке добавли ссылку на ghPages и забыла заменить на нужную. Вот ссылка на запрос https://github.com/SchizoVIv/clean-code-s1e1/pull/3 , или можно перейти сразу на мой гитхаб и увидеть нужный епозиторий, извини за неудобство")
...
var createNewTaskElement=function(taskString){
  ...
  label.className='list__ladel-task';
